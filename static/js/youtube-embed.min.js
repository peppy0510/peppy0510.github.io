...
function onPlayerStateChange(event){if(event.data==YT.PlayerState.PLAYING){players.forEach((v,i)=>{if(i!==index){v.pauseVideo();}});}}
function onPlayerError(event){}
players.push(new window.YT.Player(iframes[index].id,{height:'560',width:'315',videoId:source,playerVars:{playsinline:1,enablejsapi:1,wmode:'opaque',host:origin,origin:origin,},events:{onReady:onPlayerReady,onStateChange:onPlayerStateChange,onError:onPlayerError,},}));}}
