...
function loadYoutubeVideoId(videoId){const origin=window.location.origin;const player=new window.YT.Player(`youtube-source-${videoId}`,{height:'560',width:'315',videoId:videoId,playerVars:{autoplay:0,controls:1,playsinline:1,enablejsapi:1,modestbranding:1,origin:origin,},events:{onReady:onPlayerReady,onStateChange:onPlayerStateChange,onError:onPlayerError,},});youtubePlayers.push(player);}
